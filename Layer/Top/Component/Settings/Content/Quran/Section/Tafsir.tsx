        ...
        <div className="flex gap-2">
          {TEXT_SIZES.map((size) => (
            <Card
              ...
              `}
            >
              <span className={`text-sm font-medium ${tafsirTextSize === size.value ? "text-white dark:text-black" : "text-foreground group-hover:text-white dark:group-hover:text-black"}`}>
                {size.label}
              </span>
            </Card>
          ))}
