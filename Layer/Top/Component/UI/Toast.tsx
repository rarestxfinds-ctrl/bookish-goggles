...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "ring-offset-background hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black hover:scale-102",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn(
      "text-sm font-semibold group-hover:text-white dark:group-hover:text-black",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn(
      "text-sm opacity-90 group-hover:text-white/70 dark:group-hover:text-black/70",
      className,
    )}
    {...props}
  />
