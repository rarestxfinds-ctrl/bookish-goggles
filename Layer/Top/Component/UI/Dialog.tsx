    ...
    >
      <Container className="!p-6 relative">
        ...
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full p-1.5 opacity-70 ring-offset-background transition-opacity hover:bg-muted hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none group">
          <X className="h-4 w-4 group-hover:text-white dark:group-hover:text-black" />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-lg font-semibold leading-none tracking-tight group-hover:text-white dark:group-hover:text-black",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn(
      "text-sm text-muted-foreground group-hover:text-white/70 dark:group-hover:text-black/70",
      className
    )}
    {...props}
  />
