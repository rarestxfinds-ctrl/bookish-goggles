...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "py-1.5 pl-8 pr-2 text-sm font-semibold group-hover:text-white dark:group-hover:text-black",
      className,
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.ItemText className="group-hover:text-white dark:group-hover:text-black">
      {children}
